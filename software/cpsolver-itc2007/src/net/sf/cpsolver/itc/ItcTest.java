...
public class ItcTest {
	...
	public static Solution solve() {
        try {
            ...
            System.out.println("Best = " + solution.getBestValue());
    ...
    /**
     * Writes the solution values, best iteration and DTF to a file for future evaluation
     * @param value
     * @param iteration
     * @param dtf
     */
    private static void writeSolutionValueToFile(double value, long iteration, Object dtf){
        // The name of the file to open.
        String val = value + "    " + iteration + "    " + dtf + "\n";

        try {
            Files.write(Paths.get("solutionValues.txt"), val.getBytes(), StandardOpenOption.APPEND);
        }catch (IOException e) {
	...
	private static Solution output(Solver solver) throws Exception {
        ...
        System.out.println("Total best value of the solution is "+solution.getBestValue());
        System.out.println("Best Iteration of the solution is "+solution.getBestIteration());
        Object dtf = solution.getExtendedInfo().get("Distance to feasibility");
        writeSolutionValueToFile(solution.getModel().getTotalValue(), solution.getBestIteration(), dtf);
    ...
    // exam data/exam/exam_comp_set5.exam exam_out/se_exam_sol1.out
