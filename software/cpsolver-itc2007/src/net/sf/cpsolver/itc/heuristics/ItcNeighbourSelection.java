    ...
    public Neighbour<V,T> selectNeighbour(Solution<V,T> solution) {
        ...
        switch (iPhase) {
            case 0 :
                ...
                //System.out.println("Solution after construction = " + solution.isBestComplete());
            case 1 :
                n = iFirst.selectNeighbour(solution);
                if (n!=null) return n;
                incPhase(solution, "second");
                System.out.println("Solution after HC = " + solution.getBestValue());
                //System.out.println("Solution after HC = " + solution.isBestComplete());
            case 2 :
                //numIterGD++;
                n = iSecond.selectNeighbour(solution);
                if (n!=null) return n;
                incPhase(solution, "third");
                System.out.println("Solution after GD = " + solution.getBestValue());
                //System.out.println("Solution after GD = " + solution.isBestComplete());
            case 3 :
                //numIterSA++;
                n = (iThird==null?null:iThird.selectNeighbour(solution));
                if (n!=null) return n;
                incPhase(solution, "first");
                System.out.println("Solution after SA = " + solution.getBestValue());
                //System.out.println("Solution after SA = " + solution.isBestComplete());
            default :
                iPhase = 1;
